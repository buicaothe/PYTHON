...
def fibo1():
    ...
    for i in range(2, n + 1):
        ...
        b = temp + b
    return b
print(f'--> The Fibonacci at certain index {n}, F({n}) = ',fibo1(),' (using INTERATIVE ALGORITHM)')
...
print(f'--> The Fibonacci at certain index {n}, F({n}) = ',fibo2(n),' (using RECURSIVE ALGORITHM)')